      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="image_up.php">Upload</a></li>
...
<div class="container">
    <div class='alert alert-success'>
		<button class='close' data-dismiss='alert'>&times;</button>
			<strong>Hello <?php echo $row['user_name']; ?></strong> Welcome to the <strong>ADMIN</strong> page.
    </div>
</div>
...
<td><a class="twitter-follow-button"
  href="https://twitter.com/PradeepKhodke"
