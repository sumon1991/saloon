...
<div id="wrapper"> 
  <!-- preloader -->
  <div id="preloader">
    <div id="spinner"> <img src="images/preloaders/1.gif" alt=""><a href="index.php"> </div>
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0"> <a class="menuzord-brand pull-left flip xs-pull-center logoDiv" href="javascript:void(0)"><img src="images/logo-wide-white.png" alt=""></a> </div>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="widget no-border m-0 paddGaping">
          ...
          <div class="col-xs-12 col-sm-4 col-md-3">
            <div class="widget no-border m-0 paddGaping">
              <div class="mt-10 mb-10 text-right sm-text-center">
                <div class="font-16 text-black-f1 text-uppercase mb-5 font-weight-400 topLogindiv">
                  <?php
          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg9.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description=""> 
                ...
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme  text-white font-weight-400 m-0" 
                  id="rs-1-layer-1"
                  ...
                  style="font-family: 'Californian FB'; z-index: 5; white-space: nowrap; font-weight:400;"><span class="the"></span> <i class="cl1">A</i>ll  <i class="cl1">N</i>ew  <i class="cl1">U</i>pdated </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="font-family: 'Century Gothic'; z-index: 5; white-space: nowrap; font-weight:400;color:#eec9ff;">Gallery </div>
                ...
                <div class="tp-caption tp-resizeme text-right text-white" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; font-weight:300;">We provide the best Indian hair styling galary wiht a huge collection. </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-transparent btn-circled mr-10" href="ajax-load/reservation-form.html" data-target="#BSParentModal" data-toggle="modal">Check Now</a> </div>
              </li>
              ...
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg17.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description=""> 
                ...
                <div class="tp-caption tp-resizeme  text-white font-weight-400 m-0" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:400;"><span class="the"></span>Check Out our Various Range of </div>
                ...
                <div class="tp-caption tp-resizeme text-right text-white" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="font-family: 'Century Gothic'; z-index: 5; white-space: nowrap; font-weight:400;color:#eec9ff;"><i class="pink">P</i>roducts </div>
                ...
                <div class="tp-caption tp-resizeme text-right text-white" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; font-weight:300;">Our huge collection of <i class="pink">products</i> fulfills everyone’s requirement </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-lg btn-circled mr-10" href="#">Check Now</a> </div>
              </li>
              ...
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg15.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description=""> 
                ...
                <div class="tp-caption tp-resizeme text-white font-weight-400" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:400;"><span class="the"></span> Presenting <i class="color2">The Biggest</i> collection of Indian Hair styling </div>
                
                <!-- LAYER NR. 2 -->
                <div class="tp-caption tp-resizeme m-0" 
                  id="rs-3-layer-2"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="font-family: 'Century Gothic'; z-index: 5; white-space: nowrap; font-weight:400;color:#ffffff;"><span class="color2">V</span>ideos </div>
                ...
                <div class="tp-caption tp-resizeme font-raleway text-white" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; font-weight:300;">Our huge collection of videos contains Various hair styling & Makeovers.<br> 
Do keep on checking for Exciting Offers</div>
              ...
              <!-- SLIDE 4 -->
              <li data-index="rs-4" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg15.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description=""> 
                <!-- MAIN IMAGE --> 
                ...
                <div class="tp-caption tp-resizeme text-white font-weight-400" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:400;"><span class="thePink"></span>Interested in..... </div>
                ...
                <div class="tp-caption tp-resizeme m-0" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="font-family: 'Century Gothic'; z-index: 5; white-space: nowrap; font-weight:400;color:#ffffff;"><span class="color3">L</span>onghair <span class="color3">M</span>odelling </div>
                ...
                <div class="tp-caption tp-resizeme font-raleway text-white" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; font-weight:300;">If you are interested to become <br>
a part of <span class="text2"></span>as a model</div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-lg btn-circled mr-10" href="#">Contact Us</a> </div>
              </li>
              <li data-index="rs-5" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg15.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description=""> 
                <!-- MAIN IMAGE --> 
                ...
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme font-weight-400" 
                  id="rs-5-layer-1"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:400;color:#be5901;"><span class="thebrn"></span>Introducing for the first time </div>
                ...
                <div class="tp-caption tp-resizeme m-0" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="font-family: 'Century Gothic'; z-index: 5; white-space: nowrap; font-weight:400;color:#be5901;">Hair Session </div>
                ...
                <div class="tp-caption tp-resizeme font-raleway" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; font-weight:300;color:#be5901;">Be a Part of <span class="text3"></span> with <strong>Hair Session</strong>  </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a style="border-color:#be5901;color:#be5901;" class="btn btn-lg btn-circled mr-10" href="#">Coming Soon</a> </div>
              </li>
              ...
              <div id="grid" class="portfolio-gallery grid-4 gutter clearfix"> 
                ...
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/1.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/1.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/2.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/2.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/3.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/3.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/4.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/4.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/5.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/5.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/6.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/6.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/7.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/7.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/8.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/8.jpg" data-title="<span class='btmBtns'><button type='button' class='btn btn-info'><span>Buy Now</span></button></span>">View more</a> </div>
                </div>
                <!-- Portfolio Item End --> 
              </div>
