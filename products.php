  ...
  <header id="header" class="header">
    ...
    <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed bg-lighter">
        <div class="container">
          <div class="row">
            <nav id="menuzord-right" class="menuzord no-bg"> <a class="menuzord-brand pull-left flip" href="javascript:void(0)"><img src="images/logo-wide-white.png" alt=""></a>
              ...
              <div id="grid" class="portfolio-gallery grid-4 gutter clearfix"> 
                ...
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/1.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/1.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/2.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/2.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/3.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/3.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/4.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/4.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End --> 
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/5.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/5.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/6.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/6.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/7.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/7.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                <!-- Portfolio Item Start -->
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="images/gallery/8.jpg" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="images/gallery/8.jpg" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'><span>Buy Now</span></a></span>">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
              </div>
