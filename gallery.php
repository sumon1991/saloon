...
<div id="wrapper">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg9.jpg">
...
<?php
	...
	?>
                ...
                <div class="portfolio-item branding">
                  <div class="thumb"> <img class="img-fullwidth" src="admin/login/user_images/<?php echo $row['sellPic']; ?>" alt="project">
                    ...
                    <a class="hover-link" data-rel="prettyPhoto[gallery2]" href="admin/login/user_images/<?php echo $row['sellPic']; ?>" data-title="<span class='btmBtns'><a href='bankinfo.html' class='btn btn-info'>
					<span>Buy Now</span>
          ...
          <div class="thubmFormDiv">        
				  <form action="<?php echo $paypal_url; ?>" method="post">
						...
						<!-- Specify URLs -->
						<input type='hidden' name='cancel_return' value='https://saloon-sumonsen.c9users.io/saloon/cancel.php'>
						<input type='hidden' name='return' value='https://saloon-sumonsen.c9users.io/saloon/success.php'>
